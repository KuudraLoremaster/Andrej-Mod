package net.kuudraloremaster.andrejmod.worldgen;
...
public class ModBiomeModifiers {
    ...
    private static ResourceKey<BiomeModifier> registerKey(String name) {
        return ResourceKey.create(ForgeRegistries.Keys.BIOME_MODIFIERS, new ResourceLocation(AndrejMod.MOD_ID, name));
    }
}
