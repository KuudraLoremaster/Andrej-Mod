package net.kuudraloremaster.andrejmod.worldgen.portal;
...
public class ModTeleporter implements ITeleporter {
    ...
    public Entity placeEntity(Entity entity, ServerLevel currentWorld, ServerLevel destinationWorld,
        ...
        entity.setPos(destinationPos.getX(), 14, destinationPos.getZ());
        entity.teleportTo(destinationPos.getX(), 14, destinationPos.getZ());
        return entity;
    }
}
