package net.kuudraloremaster.andrejmod.entity.client;// Made with Blockbench 4.8.3
...
public class RhinoModel<T extends Entity> extends HierarchicalModel<T> {
	...
	public RhinoModel(ModelPart root) {
		...
		this.head = root.getChild("rhino").getChild("body").getChild("torso").getChild("head");
	}
