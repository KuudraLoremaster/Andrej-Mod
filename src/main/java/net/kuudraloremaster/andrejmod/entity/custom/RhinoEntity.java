...
import net.kuudraloremaster.andrejmod.entity.ai.RhinoAttackGoal;
...
public class RhinoEntity extends Animal {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new TemptGoal(this, 1.15D, Ingredient.of(Items.COOKED_BEEF), false));
