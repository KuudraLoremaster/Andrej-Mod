...
import net.kuudraloremaster.andrejmod.entity.ai.RaAttackGoal;
...
import static net.kuudraloremaster.andrejmod.entity.ModEntities.RA;

public class RaEntity extends Animal {
    public RaEntity(EntityType<? extends Animal> pEntityType, Level pLevel) {
    ...
    protected void populateDefaultEquipmentSlots(RandomSource pRandom, DifficultyInstance pDifficulty) {
        ...
        this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(ModItems.SAPPHIRE_STAFF.get()));
    }

    private static final EntityDataAccessor<Boolean> ATTACKING =
            SynchedEntityData.defineId(RaEntity.class, EntityDataSerializers.BOOLEAN);
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new RaAttackGoal(this, 1.15D, false));
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Animal.createLivingAttributes()
                ...
                .add(Attributes.ATTACK_KNOCKBACK, 7f)
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob ageableMob) {
        return RA.get().create(serverLevel);
    }
