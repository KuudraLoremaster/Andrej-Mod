package net.kuudraloremaster.andrejmod.block.entities.renderer;

import com.mojang.blaze3d.vertex.PoseStack;
import com.mojang.math.Axis;
import net.kuudraloremaster.andrejmod.block.entities.GemPolishingStationBlockEntity;
...
public class GemPolishingBlockEntityRenderer implements BlockEntityRenderer<GemPolishingStationBlockEntity> {
    ...
    public void render(GemPolishingStationBlockEntity gemPolishingStationBlockEntity, float v, PoseStack poseStack, MultiBufferSource multiBufferSource, int i, int i1) {
        ...
        itemRenderer.renderStatic(itemStack, ItemDisplayContext.FIXED, getLightLevel(gemPolishingStationBlockEntity.getLevel(), gemPolishingStationBlockEntity.getBlockPos()), OverlayTexture.NO_OVERLAY,
        poseStack, multiBufferSource, gemPolishingStationBlockEntity.getLevel(), 1);
        poseStack.popPose();
    }
